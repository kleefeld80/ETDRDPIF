...
function efficiency_plot_ekinetics(Time_mat,Error_mat)
...
loglog(error3,time3,'p-.','color',c(3,:),...
    'LineWidth',ls,...
    'MarkerSize',siz)
%loglog(error4,time4,'^-.','color',c(4,:),...
%    'LineWidth',ls,...
%    'MarkerSize',siz)
loglog(error5,time5,'<-.','color',c(5,:),...
    'LineWidth',ls,...
    'MarkerSize',siz)
loglog(error6,time6,'v-.','color',c(7,:),...
    'LineWidth',ls,...
    'MarkerSize',siz)
grid on
...
legend('ETD-RDP','IMEX-BDF2','IMEX-TR','IMEX-Adams2','ETD-RDP-IF')
